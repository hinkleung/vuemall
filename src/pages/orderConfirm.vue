        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            ...
            <select name="district" v-model="checkedItem.receiverDistrict">
              ...
              <option value="北京">海淀区</option>
              <option value="北京">东城区</option>
              <option value="北京">西城区</option>
              <option value="北京">顺义区</option>
              <option value="北京">房山区</option>
            </select>
          </div>
          <div class="item">
  ...
  methods:{
    ...
    getCartList(){
        this.axios.get('/carts').then((res)=>{
          ...
          this.cartList = list.filter(item=>item.productSelected);//获取购物车选中的商品列表
          list.map((item)=>{
